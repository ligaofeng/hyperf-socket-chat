...
class SocketIO extends \Hyperf\SocketIOServer\SocketIO
{
    ...
    function __construct(\Hyperf\Contract\StdoutLoggerInterface $stdoutLogger, \Hyperf\WebSocketServer\Sender $sender, \Hyperf\SocketIOServer\Parser\Decoder $decoder, \Hyperf\SocketIOServer\Parser\Encoder $encoder, \Hyperf\SocketIOServer\SidProvider\SidProviderInterface $sidProvider)
    {
    ...
    public function onClose($server, int $fd, int $reactorId) : void
    {
        ...
        $emitData = json_encode(['type' => 3, 'data' => ['time' => date('Y-m-d H:i:s'), 'msg' => $msg]]);
